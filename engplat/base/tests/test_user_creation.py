...
def test_user_creation_content_form(resp):
    ...
    assert_contains(resp, '<input type="password" name="password1" autocomplete="new-password" '
    ...
    assert_contains(resp, '<input type="password" name="password2" autocomplete="new-password" '
